...
ENT.PrintName		= "NPC Sensor";
ENT.Author			= "Aska";
ENT.Purpose			= "Will remain OFF until the required number of NPCs enters its space, will then output ON";
...
CHECKEM.RegisterCheckEmGate("ce_sensor_npc", "NPC", "Sensors");

CHECKEM.SetupCustomVars("ce_sensor_npc",
	{"Number Of NPCs", "NumNPC", 1, 1, 64},
